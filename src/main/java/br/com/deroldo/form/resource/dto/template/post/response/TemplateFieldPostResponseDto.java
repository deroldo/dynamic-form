...
public class TemplateFieldPostResponseDto {
    ...
    private List<RadioPostResponseDto> radios;

    public TemplateFieldPostResponseDto() {
    }

    public TemplateFieldPostResponseDto(final TemplateField templateField) {
        ...
        this.radios = templateField.getRadios().isEmpty() ? null :
                templateField.getRadios().stream().map(RadioPostResponseDto::new).collect(Collectors.toList());
    }
    ...
    public List<RadioPostResponseDto> getRadios() {
        return radios;
    }
}
